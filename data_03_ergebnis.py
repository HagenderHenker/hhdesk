...
def gesamtplan_fin(df):
   ...
   findic = {
      ...
      "inv_slz_2pj" : df.loc[(df["sk"]<690000) & (df["sk"]>680000)]["plan2"].sum() -  df.loc[(df["sk"]<790000) & (df["sk"]>780000)]["plan2"].sum(),
      "inv_slz_3pj" : df.loc[(df["sk"]<690000) & (df["sk"]>680000)]["plan3"].sum() -  df.loc[(df["sk"]<790000) & (df["sk"]>780000)]["plan3"].sum(),
      "finm_slz_2vj" : df.loc[(df["sk"]<690000) & (df["sk"]>680000)]["rgergvvj"].sum() - df.loc[(df["sk"]<790000) & (df["sk"]>780000)]["rgergvvj"].sum()+ordslzvj2+aoslzvj2,
      "finm_slz_1vj" : df.loc[(df["sk"]<690000) & (df["sk"]>680000)]["ansvj"].sum() -  df.loc[(df["sk"]<790000) & (df["sk"]>780000)]["ansvj"].sum() + ordslzvj1 + aoslzvj1,
      "finm_slz_hhj" : df.loc[(df["sk"]<690000) & (df["sk"]>680000)]["anshhj"].sum() - df.loc[(df["sk"]<790000) & (df["sk"]>780000)]["anshhj"].sum() + ordslzhhj + aoslzhhj,
      "finm_slz_1pj" : df.loc[(df["sk"]<690000) & (df["sk"]>680000)]["plan1"].sum() -  df.loc[(df["sk"]<790000) & (df["sk"]>780000)]["plan1"].sum() + ordslzpl1 + aoslzpl1, 
      "finm_slz_2pj" : df.loc[(df["sk"]<690000) & (df["sk"]>680000)]["plan2"].sum() -  df.loc[(df["sk"]<790000) & (df["sk"]>780000)]["plan2"].sum()+ ordslzpl2 + aoslzpl2,
      "finm_slz_3pj" : df.loc[(df["sk"]<690000) & (df["sk"]>680000)]["plan3"].sum() -  df.loc[(df["sk"]<790000) & (df["sk"]>780000)]["plan3"].sum()+ ordslzpl3 + aoslzpl3,
